...
export default function EducationTab({ items, onAdd, onUpdate, onRemove, onReorder }) {
    ...
    <div>
      ...
      {items.length === 0 && (
        <div className="empty-state">
          <div className="empty-icon"><GraduationCapIcon size={28} strokeWidth={1.6} /></div>
      ...
      {items.map((f, idx) => (
        <div
          key={f.id}
          className={`item-card${dragOverId === f.id ? ' dnd-over' : ''}`}
          draggable
